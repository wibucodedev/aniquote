...
export default function Navbar() {
	return (
		<UI.Navbar className="bg-gray-800 fixed backdrop-opacity-50 px-12">
			<UI.Navbar.Start>
				<UI.Dropdown>
					...
					<UI.Dropdown.Menu className="my-2 shadow-md rounded-md bg-gray-800 outline outline-1 outline-gray-600">
						<UI.Dropdown.Item>About</UI.Dropdown.Item>
						<UI.Dropdown.Item>Category</UI.Dropdown.Item>
						<UI.Dropdown.Item>Donate</UI.Dropdown.Item>
					</UI.Dropdown.Menu>
				</UI.Dropdown>
			</UI.Navbar.Start>
			<UI.Navbar.Center>
